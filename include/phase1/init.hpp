...
void load_graph(const char *filename, int procId, int nprocs, std::unordered_map<int, std::vector<int>> &adj, std::unordered_map<int, int> &local_adj, int &V, uint64_t &E);
